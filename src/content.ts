...
export const eventContent = {
  ...
  checkpointTitle: "探検する場所",
  checkpointCountSuffix: "SPOTS",
  ...
  duplicateCelebrationLabel: "STAMP ALREADY COLLECTED",
  duplicateCelebrationTitle: "このスタンプはすでに取得しています",
  duplicateCelebrationNext: "ほかの場所も探検してみよう！",
  stampImpactGet: "GET!",
  stampImpactComplete: "COMPLETE",
  stampCardLabel: "STAMP CARD",
  stampSpaceLabel: "STAMP SPACE",
